...
![](/assets/eclipse/4.7-oxygen-eclipse-plugins/01.png)

インストールする Plug-in の 選択画面が表示されるので、[作業対象] に [--すべての使用可能なサイト--] を 選択します.
![](/assets/eclipse/4.7-oxygen-eclipse-plugins/02.png)
